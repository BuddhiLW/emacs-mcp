(ns hive-mcp.emacs.olympus
  "Delegation shim — routes to hive-emacs.olympus.

   Implementation extracted to the hive-emacs project. This shim aliases
   every public from hive-emacs.olympus via runtime intern so existing
  ...
  (:require [hive-emacs.olympus]))
;; Copyright (C) 2026 Pedro Gomes Branquinho (BuddhiLW) <pedrogbranquinho@gmail.com>
;;
;; SPDX-License-Identifier: AGPL-3.0-or-later

(doseq [[sym v] (ns-publics 'hive-emacs.olympus)]
