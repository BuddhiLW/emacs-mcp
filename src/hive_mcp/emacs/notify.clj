(ns hive-mcp.emacs.notify
  "Delegation shim — routes to hive-emacs.notify.

   Implementation extracted to the hive-emacs project. This shim aliases
   every public from hive-emacs.notify via runtime intern so existing
  ...
  (:require [hive-emacs.notify]))
;; Copyright (C) 2026 Pedro Gomes Branquinho (BuddhiLW) <pedrogbranquinho@gmail.com>
;;
;; SPDX-License-Identifier: AGPL-3.0-or-later

(doseq [[sym v] (ns-publics 'hive-emacs.notify)]
